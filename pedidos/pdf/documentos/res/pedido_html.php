...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
			<td class='pumpkin' style="width:45%; ">PLAZA COMERCIAL</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
			<td class='pumpkin' style="width:33%; ">FORMAS ENTREGA</td>
			<td class='pumpkin' style="width:34%; ">METODO DE PAGO</td>
    ...
    <table cellspacing="0" style="width: 100%; border: solid 0px #7f8c8d; text-align: center; font-size: 10pt;padding:1mm;">
        <tr >
            <th class="pumpkin" style="width: 14% ">CODIGO DE PRODUCTO</th>
			<th class="pumpkin" style="width: 7% ">CANT.</th>
            <th class="pumpkin" style="width: 55%">DESCRIPCION DE EL PRODUCTO</th>
            <th class="pumpkin" style="width: 14%;text-align:right">PRECIO POR UNIDAD.</th>
...
?>
	...
	<br>
	<p style="font-size:11pt;text-align:center">Si tiene alguna consulta sobre este pedido por favor contácte a:<br><br>
