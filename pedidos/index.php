  ...
  <body>
    ...
    <div class="container">
		  <div class="row-fluid">
			...
			<div class="col-md-12">
			<h2><span class="glyphicon glyphicon-edit"></span> Realiza un pedido</h2>
			<hr>
			<form class="form-horizontal" role="form" id="datos_pedido">
				<div class="row">
				  
				  <div class="col-md-3">
				  <label for="proveedor" class="control-label">Selecciona la plaza Comercial</label>
					 <select class="proveedor form-control" name="proveedor" id="proveedor" required>
					</select>
				  </div>
				  
					<div class="col-md-3">
						<label for="transporte" class="control-label">Transporte para entrega</label>
						<input type="text" class="form-control input-sm" id="transporte" value="Terrestre" readonly="readonly" required>
					</div>
					
					<div class="col-md-2">
						<label for="condiciones" class="control-label">Condiciones de pago</label>
						<input type="text" class="form-control input-sm" id="condiciones" value="Contado en efectivo" readonly="readonly" required>
					</div>
